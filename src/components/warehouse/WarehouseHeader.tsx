    ...
    <header className="flex flex-col gap-6">
      ...
      <div className="relative">
        ...
        <input
          ...
          className={cn(
            'w-full rounded-full border border-border bg-card px-12 py-4 text-sm text-card-foreground shadow-sm outline-none transition-colors placeholder:text-muted-foreground',
